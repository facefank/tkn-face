...
<head>
    <meta charset="utf-8">
    <title>พนักงานดีเด่นด้านงานบริการ</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="outstandingemployee" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">พนักงานดีเด่น</a>
                        <div class="dropdown-menu m-0">
            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">พนักงานด้านบริการยอดเยี่ยม</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="home">Home</a></li>
                                <li class="breadcrumb-item text-white active" aria-current="page">พนักงานดีเด่น</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <div class="team-item">
                                ...
                                <!-- <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
                                    <a class="btn btn-square mx-1" ><i class="fas fa-thumbs-up"></i></a>
                                    <a class="btn btn-square mx-1" ><i class="fas fa-thumbs-up"></i></a>
                                    <a class="btn btn-square mx-1" ><i class="fas fa-thumbs-up"></i></a>
                                </div> -->
                                <!-- <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
