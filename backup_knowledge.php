    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                // Query to get the desired text from the database
                $stmt = $db->query("SELECT * FROM tbl_knowledge WHERE types_knowledge = 1");
                $stmt->execute();
                $row = $stmt->fetch(PDO::FETCH_ASSOC);

                // Check if a row is returned
                if ($row) {
                    $tyname_knowledge = htmlspecialchars($row['tyname_knowledge']);
                } else {
                    // Default text if no data found
                    $tyname_knowledge = "Default Knowledge Type Name";
                }
                ?>

                <h1 class="mb-5"><?php echo $tyname_knowledge; ?></h1>
                            ...
                            <a href="knowledgeDetail.php?id=<?php echo $rows['id_knowledge']; ?>">
                                <div class="team-item">
                                    ...
                                    <div class="text-center p-4">
                                        ...
                                        <!-- <small class="mb-0"><?php echo $rows["details_knowledge"]; ?></small> <br> -->
                                        <small class="mb-0"><?php echo htmlspecialchars(substr($rows["details_knowledge"], 0, 500)); ?> ........</small>
                                        <br>

                                        <br>
                                        <!-- <small>วันที่เผยแพร่ : <?php echo $rows["time"]; ?></small><br> -->
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                // Query to get the desired text from the database
                $stmt = $db->query("SELECT * FROM tbl_knowledge WHERE types_knowledge = 2");
                $stmt->execute();
                $row = $stmt->fetch(PDO::FETCH_ASSOC);
