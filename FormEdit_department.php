...
<body>
    <div class="container mt-5">
        ...
        <form action="EditDepartment_db.php" method="POST">
            ...
            if (isset($_GET['id'])) {
                ...
                $sql = $db->query("SELECT * FROM tbl_department  WHERE id = $id ");
                $sql->execute();
                $stmt = $sql->fetch();
                // echo $stmt;
            }
            ...
            <div class="mb-3 mt-3">
                ...
                <div class="mb-3 mt-3">
                    <label for="" class="form-label">แผนก / ฝ่าย </label>
                    <input type="text" class="form-control" value="<?= $stmt["department"]; ?>" placeholder="" name="department" required>
                </div>
