...
<body>
    ...
    <!-- <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            ...
            <img src="img-tkn/logo-tkn-new.png" alt="" style="width: 140px;" class="">
    ...
    <div class="container mt-5">
        ...
        <form action="EditEmployeeResign_db.php" method="POST" enctype="multipart/form-data">
            ...
            if (isset($_GET['id'])) {
                ...
                $sql = $db->query("SELECT* FROM tbl_employeeresign WHERE id = $id");
                $sql->execute();
                $stmt = $sql->fetch();
            } //isset
            ?>

            <h1>แก้ไขข้อมูลพนักงานลาออก</h1>
            <hr>
            ...
            <div class="mb-3">
                ...
                <input type="hidden" class="form-control" value="<?= $stmt['img_employeeresign']; ?>" name="img2_employeeresign" require>
            </div>

            <div class="mb-3 mt-3">
                <label for="id_employeeresign" class="form-label">รหัสพนักงาน</label>
                <input type="text" class="form-control" value="<?= $stmt['id_employeeresign']; ?>" placeholder="" name="id_employeeresign" >
            </div>

            <div class="mb-3 mt-3">
                <label for="img_employeeresign" class="form-label">อัพโหลดรูปภาพ</label>
                <input type="file" class="form-control" placeholder="อัพโหลดรูปภาพ" id="imgInputresign" name="img_employeeresign"></br>
                <img src="uploads_img_employeeresign/<?= $stmt['img_employeeresign']; ?>" width="100px" id="PreviewImgresign" class="">
            </div>
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="text" class="form-control" value="<?= $stmt['title_employeeresign']; ?>" placeholder="" name="title_employeeresign" >
            </div>

            <div class="mb-3 mt-3">
                <label for="details_employeeresign" class="form-label">รายละเอียด</label>
                <input class="form-control " value="<?= $stmt['details_employeeresign']; ?>" placeholder="" name="details_employeeresign" ></input>
            </div>

            <div class="mb-3 mt-3">
                <label for="position_employeeresign" class="form-label">ตำแหน่ง</label>
                <input type="text" class="form-control " value="<?= $stmt['position_employeeresign']; ?>" placeholder="" name="position_employeeresign" >
            </div>
