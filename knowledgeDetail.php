...
<body>
    ...
    <div class="card">
        ...
        <?php
                ...
                // Prepare and execute the SQL query with the id
                $stmt = $db->prepare("SELECT * FROM tbl_knowledge WHERE types_knowledge  AND id_knowledge = :id");
                ...
                if (!$rows) {
                    ...
                    foreach ($rows as $row) {
                ?>
                        <div class="container" style="width: 70%; max-height: 70%; "   data-wow-delay="0.1s">
                            
                                <div >
                                    <div >
                                        <img class="img-fluid" style=" height: 400px; width: 400px; object-fit:cover; align-items: center; margin-left: auto ;margin-right: auto; display: block;" src="upload_img_knowledge/<?php echo htmlspecialchars($row['img_knowledge']); ?>">
                                    </div>
                                    <div class="text-center p-4">
                                        <h5><?php echo htmlspecialchars($row["topic_knowledge"]); ?></h5>
                                        <small class="mb-0"><?php echo htmlspecialchars($row["details_knowledge"]); ?></small><br><br>
                                        <div class="d-flex border-top">
                                            <small class="flex-fill text-center py-2"><i class="fa fa-calendar-alt text-primary me-2"></i><?php echo htmlspecialchars($row["time"]); ?></small>
                                        </div>
                                        <br>
                                    </div>
                                </div>
